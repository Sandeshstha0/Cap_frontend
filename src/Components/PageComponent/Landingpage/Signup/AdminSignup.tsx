  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        toast.success(
          "AdminSignup successful! Please check your email for verification."
        );
        setFormData({
          firstName: "",
          lastName: "",
      ...
      toast.error("AdminSignup failed. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      ...
      <div className="w-full max-w-4xl mx-auto bg-gradient-to-br from-white to-gray-100 shadow-lg rounded-xl md:flex overflow-hidden">
        <div className="hidden md:flex flex-col items-center justify-center w-1/2 p-4 bg-gradient-to-b from-primary to-orange-400">
          <img
            src="/cuate.png"
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-center p-10">
          <form className="flex flex-col items-center space-y-6 w-full">
            ...
            Budget Expert Admin Portal Regestration
            </div>
