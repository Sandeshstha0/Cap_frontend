        ...
        <><div className='' >
            ...
            <div className='text-center  mt-21'>
                <h1 className="text-6xl font-semibold text-secondary drop-shadow-2xl">
                    <span className="drop-shadow-2xl border-b-4 border-secondary p-2">Do you know?</span>
                </h1>
                        ...
                        <div className="relative m-2 space-y-4">
                            <div className="flex items-center justify-between space-x-2 rounded-lg bg-white p-4 shadow-lg">
                                <div className="flex-1">
                                    <div className="h-8 p-2  rounded-md bg-slate-200 text-black font-medium text-sm">Regularly monitor  your money </div>
                                </div>
                                <div>
                            ...
                            <div className="flex items-center justify-between space-x-8 rounded-lg bg-white p-4">
                                <div className="flex-1">
                                    <div className="h-8 p-2  rounded-md bg-slate-200 text-black  text-sm ">Rather then saving invest it !! </div>
                                </div>
                                <div>
