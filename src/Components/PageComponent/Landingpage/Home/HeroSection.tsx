...
function HeroSection() {
    ...
    return (
        ...
        <section className="max-container  text-white  padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row bg-primary ">
            ...
            <div className="relative flex flex-1 items-start ">
                <div className="relative  flex w-[600px] flex-col gap-8 justify-center rounded-3xl px-7 ">
                    ...
                    <Image src="/hero.png" alt="close" width={1000} height={24} className='shadow-b-lg' />
                </div>
