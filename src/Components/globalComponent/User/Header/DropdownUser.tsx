      ...
      {dropdownOpen && (
        <div className="absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default">
          ...
          <button
            ...
            className="py-4 px-6 text-sm font-medium text-danger duration-300 ease-in-out hover:text-primary lg:text-base"
          >
            Log Out
          </button>
        </div>
