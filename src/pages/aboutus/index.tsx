  ...
  return (
    <Layout>
      <div className='relative rounded-b h-80 bg-white mt-18'>
        <img src='/1.jpg' className='object-cover w-full h-60' alt='Background' />
        
        {/* Container for the image and text */}
        <div className='absolute bottom-0  transform -translate-x-1/2 mb-4 sm:left-125 sm:transform-none text-center'>
          {/* Text above the image */}
          <h2 className='text-3xl font-semibold text-gray-800 mb-3 text-white  border-gray-800'>
  About Us
</h2>
